-- Fix cancel meeting request function to handle UUID/TEXT type mismatches
-- This function will properly cancel a meeting request with proper type casting

-- Drop existing function if it exists
DROP FUNCTION IF EXISTS cancel_meeting_request(text, text);

-- Create a new cancel function that handles type casting properly
...
-- Test the function
SELECT 'Cancel meeting request function created successfully' as status;
