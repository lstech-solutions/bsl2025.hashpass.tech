-- Fix function overloading issue by dropping old functions and creating clean new ones
...
-- Create clean can_make_meeting_request function with TEXT parameters only
...
-- Create clean insert_meeting_request function
