...
export const EVENTS: Record<string, EventConfig> = {
  'bsl2025': {
    ...
    speakers: [
      { id: '1', name: 'Claudia Restrepo', title: 'Rectora', company: 'EAFIT' },
      { id: '2', name: 'Leonardo Villar', title: 'Gerente General', company: 'Banco de la República' },
      { id: '3', name: 'César Ferrari', title: 'Superintendente Financiero de Colombia', company: 'Superintendencia Financiera' },
      { id: '4', name: 'Alberto Naudon', title: 'Consejero', company: 'Banco Central de Chile' },
      { id: '5', name: 'José Outumuro', title: 'Director Institutional sales EMEA', company: 'Crypto.com' },
      { id: '6', name: 'Efraín Barraza', title: 'Regional Expansion Manager - Latam', company: 'Tether' },
      { id: '7', name: 'Sandra Meza', title: 'Vicepresidente Control Interno y Cumplimiento', company: 'BBVA' },
      { id: '8', name: 'Sebastián Durán', title: 'Subdirector de Regulación', company: 'Superintendencia Financiera de Colombia' },
      { id: '9', name: 'Rocelo Lopes', title: 'CEO', company: 'SmartPay' },
      { id: '10', name: 'Ana Garcés', title: 'Chief Compliance Officer', company: 'Banco BHD' },
      { id: '11', name: 'Juan Carlos Reyes', title: 'Presidente', company: 'Comisión Nacional de Activos Digitales (CNAD) El Salvador' },
      { id: '12', name: 'Gabriel Santos', title: 'Presidente Ejecutivo', company: 'Colombia FinTech' },
      { id: '13', name: 'César Tamayo', title: 'Dean, School of Finance, Economics & Government', company: 'Universidad EAFIT' },
      { id: '14', name: 'Daniel Mangabeira', title: 'Vice President Strategy & Policy, Brazil & Latin America', company: 'Circle' },
      { id: '15', name: 'Juan Pablo Rodríguez', title: 'Socio de rics management', company: 'Colombia y Guatemala' },
      { id: '16', name: 'Willian Santos', title: 'Gerente de Compliance - Oficial de Cumplimiento', company: 'Banco W' },
      { id: '17', name: 'Rocío Alvarez-Ossorio', title: 'Founder & CEO', company: 'Hator' },
      { id: '18', name: 'Steffen Härting', title: 'Senior Manager', company: 'Deloitte: Crypto Asset Markets' },
      { id: '19', name: 'Diego Fernández', title: 'Gerente Corporativo de Innovación', company: 'nuam' },
      { id: '20', name: 'Andres Florido', title: 'Senior Manager - Blockchain & AI Assurance', company: 'Deloitte' },
      { id: '21', name: 'Liz Bejarano', title: 'Directora Financiera y de Riesgo', company: 'Asobancaria' },
      { id: '22', name: 'Andrés Meneses', title: 'Founder', company: 'Orbyt X' },
      { id: '23', name: 'Luther Maday', title: 'Head of Payments', company: 'Algorand Foundation' },
      { id: '24', name: 'Rafael Teruszkin', title: 'Head Latam', company: 'Bitpanda Technology Solutions' },
      { id: '25', name: 'Albi Rodríguez', title: 'Senior Web3 & DLT Consultant', company: 'Independent' },
