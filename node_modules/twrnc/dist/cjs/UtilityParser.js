...
const transform_1 = require("./resolve/transform");
const pointer_events_1 = __importDefault(require("./resolve/pointer-events"));
class UtilityParser {
    ...
    parseUtility() {
        ...
        if (this.consumePeeked(`scale-`)) {
            style = (0, transform_1.scale)(this.rest, this.context, theme === null || theme === void 0 ? void 0 : theme.scale);
            if (style)
                return style;
        }
        if (this.consumePeeked(`rotate-`)) {
            style = (0, transform_1.rotate)(this.rest, this.context, theme === null || theme === void 0 ? void 0 : theme.rotate);
            if (style)
                return style;
        }
        if (this.consumePeeked(`skew-`)) {
            style = (0, transform_1.skew)(this.rest, this.context, theme === null || theme === void 0 ? void 0 : theme.skew);
            if (style)
                return style;
        }
        if (this.consumePeeked(`translate-`)) {
            style = (0, transform_1.translate)(this.rest, this.context, theme === null || theme === void 0 ? void 0 : theme.translate);
            if (style)
                return style;
        }
        if (this.consumePeeked(`transform-none`)) {
            return (0, transform_1.transformNone)();
        }
        if (this.consumePeeked(`origin-`)) {
            style = (0, transform_1.origin)(this.rest, this.context, theme === null || theme === void 0 ? void 0 : theme.transformOrigin);
            if (style)
                return style;
        }
        if (this.consumePeeked(`pointer-events-`)) {
            style = (0, pointer_events_1.default)(this.rest);
            if (style)
                return style;
        }
