...
function create(customConfig, platform, reactNativeVersion) {
    ...
    function style(...inputs) {
        ...
        for (const utility of utilities) {
            ...
            if (!styleIr) {
                const parser = new UtilityParser_1.default(utility, config, cache, device, reactNativeVersion);
    ...
    tailwindFn.prefixMatch = (...prefixes) => {
        ...
        const parser = new UtilityParser_1.default(`${joined}:flex`, config, cache, device, reactNativeVersion);
