...
const SCREENSHOT_DIR = path.join(__dirname, '..', 'emails', 'assets', 'images', 'screenshots');
...
const screenshots = [
  {
    name: 'sign-in-screen',
    url: '/auth',
    description: 'Sign-in screen with email input field',
    waitFor: 'input[type="email"], input[placeholder*="email" i], input[placeholder*="correo" i]',
    waitTime: 3000
  },
  {
    name: 'explore-speakers-screen',
    url: '/dashboard/explore',
    description: 'Speaker list/explore screen',
    waitFor: 'body',
    waitTime: 5000
  },
  {
    name: 'speaker-profile-screen',
    url: '/events/bsl2025/speakers',
    description: 'Speaker profile with request meeting button',
    waitFor: 'body',
    waitTime: 5000
  },
  {
    name: 'request-meeting-screen',
    url: '/events/bsl2025/speakers/calendar',
    description: 'Request meeting screen with form',
    waitFor: 'body',
    waitTime: 5000
  },
  {
    ...
    description: 'Notifications/requests screen',
    waitFor: 'body',
    waitTime: 5000
  }
];
...
(async () => {
  ...
  if (!isRunning) {
    ...
    console.log('   APP_URL=http://localhost:8081 node scripts/capture-email-screenshots.js\n');
