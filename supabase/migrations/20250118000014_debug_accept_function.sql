-- Debug version of accept_meeting_request function
-- This version doesn't create chat messages to isolate the issue

CREATE OR REPLACE FUNCTION accept_meeting_request_debug(
...
-- Grant permissions
GRANT EXECUTE ON FUNCTION accept_meeting_request_debug(UUID, TEXT, TIMESTAMP WITH TIME ZONE, TEXT, TEXT, TEXT) TO authenticated;
