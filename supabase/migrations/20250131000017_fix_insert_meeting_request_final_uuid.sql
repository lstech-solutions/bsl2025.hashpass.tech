-- Final fix: Ensure insert_meeting_request uses UUID correctly with explicit casts
...
BEGIN
    ...
    -- Ensure we get UUID type with explicit cast
    ...
    -- Use explicit casts for all values to ensure type compatibility
    INSERT INTO public.meeting_requests (
        id, 
        requester_id, 
        speaker_id,  -- This column is UUID
        speaker_name, 
        requester_name,
        requester_company, 
        requester_title, 
        ...
        new_request_id::UUID, 
        requester_uuid::UUID, 
        speaker_user_id::UUID,  -- Explicit UUID cast
        p_speaker_name::TEXT, 
        p_requester_name::TEXT,
