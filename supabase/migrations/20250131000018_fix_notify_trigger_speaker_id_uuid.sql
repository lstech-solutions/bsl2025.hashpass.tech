-- Fix notify_meeting_request_created to work with UUID speaker_id
-- Temporarily disable trigger, fix function, then re-enable
ALTER TABLE public.meeting_requests DISABLE TRIGGER trigger_notify_meeting_request_created;
...
ALTER TABLE public.meeting_requests ENABLE TRIGGER trigger_notify_meeting_request_created;
