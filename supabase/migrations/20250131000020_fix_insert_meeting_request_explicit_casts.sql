-- Fix insert_meeting_request with explicit casts in SELECT
-- This ensures PostgreSQL recognizes all values as their correct types
...
BEGIN
    ...
    -- Use INSERT ... SELECT with explicit casts to ensure type safety
