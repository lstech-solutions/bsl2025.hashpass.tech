-- Fix can_make_meeting_request to handle UUID speaker_id in user_blocks
-- p_speaker_id is TEXT (could be UUID string or old slug), but user_blocks.speaker_id is UUID
