-- Force UUID type by explicitly casting in VALUES clause
-- Sometimes PostgreSQL needs the cast even with typed variables
...
BEGIN
    ...
    -- Step 12: Insert using VALUES with EXPLICIT UUID cast in VALUES clause
    -- Even though speaker_user_id is UUID, PostgreSQL sometimes needs explicit cast
