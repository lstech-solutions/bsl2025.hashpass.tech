-- Use subquery directly in VALUES clause with explicit type casting
-- This bypasses any variable type inference issues
...
BEGIN
    ...
    -- Step 12: Insert using VALUES with subquery directly in VALUES clause
    -- This ensures PostgreSQL evaluates the type correctly
    INSERT INTO public.meeting_requests (
        ...
        new_request_id,
        requester_uuid,
        (SELECT user_id FROM public.bsl_speakers WHERE id = speaker_uuid)::UUID,  -- Subquery with explicit cast
        p_speaker_name,
        p_requester_name,
        p_requester_company,
        p_requester_title,
