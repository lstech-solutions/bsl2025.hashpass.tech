-- Infer free slots from event schedule
-- Generate slots for event days (Nov 12, 13, 14) from 8:00 AM to 7:00 PM
-- Assume slots are free UNLESS they are blocked or confirmed
-- Prioritize slots marked as "interested"
...
COMMENT ON FUNCTION get_speaker_available_slots IS 'Infers free slots from event schedule (Nov 12-14, 8 AM - 7 PM, 15-min intervals). Assumes slots are free unless blocked or confirmed. Prioritizes "interested" status. Also includes explicitly marked slots from user_agenda_status.';
