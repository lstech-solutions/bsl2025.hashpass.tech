-- Ensure id has a default to prevent NULL violations
DO $$
BEGIN
  BEGIN
    EXECUTE 'ALTER TABLE public.event_agenda ALTER COLUMN id SET DEFAULT gen_random_uuid()';
  EXCEPTION WHEN OTHERS THEN
    BEGIN
      EXECUTE 'ALTER TABLE public.event_agenda ALTER COLUMN id SET DEFAULT gen_random_uuid()::text';
    EXCEPTION WHEN OTHERS THEN
      -- If both fail, leave as-is (inserts use NOT EXISTS and may still work if id is nullable)
      NULL;
    END;
  END;
END $$;

-- Insert BSL 2025 Day 2 agenda items (2025-11-13) - v2
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-13T09:00:00Z', 'Exchanges en la Nueva Era del Dinero Digital: Regulación, Confianza y Adopción Masiva', NULL, ARRAY['Speaker TBD']::text[], 'keynote', 'Auditorio Principal', '2'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-13T09:30:00Z', 'Hacia la convergencia regulatoria: los retos de armonizar los mercados de valores tokenizados entre América Latina, EE. UU. y la Unión Europea', NULL, ARRAY['Panelists TBD']::text[], 'panel', 'Sala Panel A', '2'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-13T10:35:00Z', 'Custodia Institucional de Activos Digitales', NULL, ARRAY['Speaker TBD']::text[], 'keynote', 'Auditorio Principal', '2'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-13T11:05:00Z', 'Finanzas Tradicionales y Activos Digitales: ¿Competencia o Complemento?', NULL, ARRAY['Panelists TBD']::text[], 'panel', 'Sala Panel B', '2'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-13T12:10:00Z', 'El Rol de la Tokenización en la Evolución de los Mercados de Capitales', NULL, ARRAY['Panelists TBD']::text[], 'panel', 'Auditorio Principal', '2'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-13T14:00:00Z', 'PSAV y los bancos, el rol del Compliance', NULL, ARRAY['Panelists TBD']::text[], 'panel', 'Sala Panel A', '2'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-13T15:05:00Z', 'Fiscalización de los criptoactivos: desafíos y oportunidades', NULL, ARRAY['Speaker TBD']::text[], 'keynote', 'Auditorio Principal', '2'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-13T15:35:00Z', 'Compliance como motor de adopción: la nueva era de los activos digitales regulados', NULL, ARRAY['Speaker TBD']::text[], 'keynote', 'Auditorio Principal', '2'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-13T15:55:00Z', 'Road to Adoption: Estrategias para la institucionalización de los activos tokenizados', NULL, ARRAY['Panelists TBD']::text[], 'panel', 'Sala Panel B', '2'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-13T17:00:00Z', 'Tokenización de Activos Climáticos', NULL, ARRAY['Speaker TBD']::text[], 'keynote', 'Auditorio Principal', '2'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-13T17:30:00Z', 'Blockchain y su fundamento técnico-financiero: Criptografía y smart contracts', NULL, ARRAY['Panelists TBD']::text[], 'panel', 'Auditorio Principal', '2'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
-- Insert BSL 2025 Day 3 agenda items (2025-11-14) - v2
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-14T09:00:00Z', 'Digitalización e Innovación en el Banco de la República', NULL, ARRAY['Speaker TBD']::text[], 'keynote', 'Auditorio Principal', '3'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-14T09:35:00Z', 'Stablecoins como Infraestructura: Más Allá del Dinero Digital', NULL, ARRAY['Panelists TBD']::text[], 'panel', 'Sala Panel A', '3'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-14T10:40:00Z', 'Infraestructura de pagos para la nueva economía latinoamericana: cómo se está moviendo el dinero del mañana', NULL, ARRAY['Speaker TBD']::text[], 'keynote', 'Auditorio Principal', '3'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-14T11:20:00Z', 'Interoperabilidad y eficiencia en pagos cross-border con stablecoins', NULL, ARRAY['Panelists TBD']::text[], 'panel', 'Sala Panel B', '3'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-14T12:25:00Z', 'Experiencia Global en Stablecoins', NULL, ARRAY['Speaker TBD']::text[], 'keynote', 'Auditorio Principal', '3'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-14T14:00:00Z', 'Compliance y Tributación en el Ecosistema DeFi y Stablecoins', NULL, ARRAY['Panelists TBD']::text[], 'panel', 'Auditorio Principal', '3'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-14T15:05:00Z', 'Ecosistemas colaborativos para la economía tokenizada', NULL, ARRAY['Speaker TBD']::text[], 'keynote', 'Auditorio Principal', '3'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-14T15:35:00Z', 'DeFi + TradFi: Nuevas sinergias en infraestructura financiera descentralizada', NULL, ARRAY['Panelists TBD']::text[], 'panel', 'Sala Panel A', '3'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-14T16:40:00Z', 'Blockchain como infraestructura económica: el caso de Hive y la tokenización del valor digital', NULL, ARRAY['Speaker TBD']::text[], 'keynote', 'Auditorio Principal', '3'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
...
INSERT INTO public.event_agenda (event_id, time, title, description, speakers, type, location, day)
SELECT 'bsl2025', '2025-11-14T17:10:00Z', 'Sistema Financiero Global en 2030: Visión, riesgos y oportunidades', NULL, ARRAY['Panelists TBD']::text[], 'panel', 'Auditorio Principal', '3'
WHERE NOT EXISTS (
  SELECT 1 FROM public.event_agenda 
