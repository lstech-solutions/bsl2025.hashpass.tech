-- Add missing insert_meeting_request function
-- This function is required for creating meeting requests
...
-- Add comment
COMMENT ON FUNCTION insert_meeting_request(text,text,text,text,text,text,text,text,text,text,numeric,integer,timestamp with time zone) IS 'Creates a new meeting request with validation and pass management';
