-- Fix type mismatches in insert_meeting_request function
-- Fix the requester_id comparison and insertion
...
-- Add comment
COMMENT ON FUNCTION insert_meeting_request(text,text,text,text,text,text,text,text,text,text,numeric,integer,timestamp with time zone) IS 'Creates a new meeting request with proper type handling';
