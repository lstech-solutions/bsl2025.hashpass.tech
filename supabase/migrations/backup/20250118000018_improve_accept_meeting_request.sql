-- Improved accept_meeting_request function
-- This version properly links the meeting request with the created meeting
...
BEGIN
    ...
    SET status = 'accepted',
        meeting_id = new_meeting_id,  -- Link the meeting request to the meeting
        updated_at = NOW()
    WHERE id = p_meeting_request_id;
