-- Update accept_meeting_request function to include notification titles
-- This makes notifications more user-friendly and avoids NULL title issues
...
BEGIN
    ...
    SET status = 'accepted',
        ...
        updated_at = NOW(),
        meeting_scheduled_at = COALESCE(p_scheduled_at, NOW() + INTERVAL '1 day'),
